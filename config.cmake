...
find_program(TMP_CMAKE_AR NAMES ${CMAKE_AR_NAMES} NO_CACHE)
find_program(TMP_CMAKE_CXX_COMPILER NAMES ${CMAKE_CXX_COMPILER_NAMES} NO_CACHE)
find_program(TMP_CMAKE_C_COMPILER NAMES ${CMAKE_C_COMPILER_NAMES} NO_CACHE)
find_program(TMP_CMAKE_LINKER NAMES ${CMAKE_LINKER_NAMES} NO_CACHE)
find_program(TMP_CMAKE_MT NAMES ${CMAKE_MT_NAMES} NO_CACHE)
find_program(TMP_CMAKE_RC_COMPILER NAMES ${CMAKE_RC_COMPILER_NAMES} NO_CACHE)
...
if(MSVC)
    if("20" STREQUAL "${CMAKE_CXX_STANDARD}" AND "${CMAKE_CXX_STANDARD_REQUIRED}" AND (NOT "/std:c++20" IN_LIST CMAKE_CXX_FLAGS AND NOT "-std=c++20" IN_LIST CMAKE_CXX_FLAGS))
        list(PREPEND CMAKE_CXX_FLAGS "/std:c++20")
    endif()
